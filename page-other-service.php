...
<article id="other" class="">
  ...
  <div class="s-page__head">
    ...
    <p class="s-page__head-txt">将来の安心を支える資金計画のシミュレーションの作成、MAS監査のサポート、<br>
    そして相続に関するご相談など、お客様のさまざまなお悩みに真摯に向き合っています。<br>
    <br>
    一人ひとりのお客様に寄り添う姿勢を何よりも大切にし、<br>
    丁寧なヒアリングを通じて、それぞれの想いや目標にしっかりと応えるサポートを心がけています。<br>
    専門知識と豊富な経験を基に、お客様が納得し安心できる解決策を一緒に考え、<br>
    実現していくことが私たちの使命です。大切な未来を共に描き、信頼できるパートナーとして全力でサポートいたします。</p>
  </div>
      ...
      <div class="s-section__inner">
        ...
        <div class="other-flex js-fade__bottom --bottom">
          ...
          <div class="other-flex__item --txt --right">
            <strong class="other-flex__ttl">
              <span class="other-flex__ttl-sub s-font__en">Others.02</span>
              MAS監査
            </strong>
            <p class="other-flex__txt">単なる会計監査ではなく、経営改善や戦略策定のための具体的な助言を行うことに重点を置いています。財務諸表や経営データを精査し、収益性や資金効率の分析を通じて、経営状況を多角的に把握。課題抽出に基づく改善策を提案し、具体的なアクションプランを提示します。突発的な経営問題や意思決定の場面にも迅速に対応し、持続的な成長をサポート。経営の透明性と信頼性を向上させ、経営資源の有効活用を促進することで競争力を強化します。MAS監査を通じ、現状把握にとどまらず、未来を見据えた経営支援を実現します。</p>
          </div>
        </div>
        ...
        <div class="other-flex js-fade__bottom --bottom">
          <div class="other-flex__item --txt --left">
            ...
            <p class="other-flex__txt">相続は法律・税務・家族間の調整などが絡む複雑な問題であり、適切な判断には専門的な視点が欠かせません。他の専門家のアドバイスを受けている場合でも、第三者の立場から冷静かつ客観的に精査し、最善の選択肢をご提案します。<br>
      ...
      <div class="s-section__inner js-fade__bottom --bottom">
        <div class="s-page__link-flex">
          ...
          <div class="s-page__flex-item --txt">
            <strong class="s-page__item-ttl">未来を見据えた総合的なサポートをいたします</strong>
            <p class="s-page__item-txt">上辻会計事務所は会計の枠に捉われず、経営にまつわる多岐にわたる専門的なサービスを提供します。どんな悩みにも寄り添い、最適なアドバイスで安心をお届けしますので、どんな些細なお悩みでも、是非一度お聞かせください。</p>
